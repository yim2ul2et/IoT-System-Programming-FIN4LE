...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/matchsettingsselector.hpp"
...
void cvv::qtutil::MatchSettingsSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MatchSettingsSelector *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (MatchSettingsSelector::*)(MatchSettingsSelector * );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::MatchSettingsSelector::staticMetaObject = { {
    QMetaObject::SuperData::link<MatchSettings::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__MatchSettingsSelector.data,
    qt_meta_data_cvv__qtutil__MatchSettingsSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
