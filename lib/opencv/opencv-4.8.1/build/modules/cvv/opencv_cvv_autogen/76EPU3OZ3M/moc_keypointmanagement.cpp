...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/keypointmanagement.hpp"
...
void cvv::qtutil::KeyPointManagement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KeyPointManagement *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (KeyPointManagement::*)(const std::vector<cv::KeyPoint> & );
        ...
        {
            using _t = void (KeyPointManagement::*)(KeyPointSettings & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::KeyPointManagement::staticMetaObject = { {
    QMetaObject::SuperData::link<KeyPointSettings::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__KeyPointManagement.data,
    qt_meta_data_cvv__qtutil__KeyPointManagement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
