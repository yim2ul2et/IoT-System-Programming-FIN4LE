...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/matchselection.hpp"
...
void cvv::qtutil::MatchSelection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MatchSelection *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::MatchSelection::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__MatchSelection.data,
    qt_meta_data_cvv__qtutil__MatchSelection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
