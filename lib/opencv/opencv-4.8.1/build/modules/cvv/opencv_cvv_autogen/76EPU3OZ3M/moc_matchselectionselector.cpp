...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/matchselectionselector.hpp"
...
void cvv::qtutil::MatchSelectionSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MatchSelectionSelector *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (MatchSelectionSelector::*)(MatchSelectionSelector * );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::MatchSelectionSelector::staticMetaObject = { {
    QMetaObject::SuperData::link<MatchSelection::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__MatchSelectionSelector.data,
    qt_meta_data_cvv__qtutil__MatchSelectionSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
