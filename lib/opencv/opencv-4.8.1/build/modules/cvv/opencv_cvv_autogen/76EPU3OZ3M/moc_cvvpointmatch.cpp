...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/cvvpointmatch.hpp"
...
void cvv::qtutil::CVVPointMatch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CVVPointMatch *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::CVVPointMatch::staticMetaObject = { {
    QMetaObject::SuperData::link<CVVMatch::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__CVVPointMatch.data,
    qt_meta_data_cvv__qtutil__CVVPointMatch,
    qt_static_metacall,
    nullptr,
    nullptr
} };
