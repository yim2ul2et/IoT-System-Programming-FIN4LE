...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/keypointselection.hpp"
...
void cvv::qtutil::KeyPointSelection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KeyPointSelection *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (KeyPointSelection::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeyPointSelection::settingsChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::KeyPointSelection::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__KeyPointSelection.data,
    qt_meta_data_cvv__qtutil__KeyPointSelection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
