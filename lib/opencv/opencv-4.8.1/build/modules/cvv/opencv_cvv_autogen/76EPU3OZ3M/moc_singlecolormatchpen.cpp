...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/singlecolormatchpen.hpp"
...
void cvv::qtutil::SingleColorMatchPen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SingleColorMatchPen *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::SingleColorMatchPen::staticMetaObject = { {
    QMetaObject::SuperData::link<MatchSettings::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__SingleColorMatchPen.data,
    qt_meta_data_cvv__qtutil__SingleColorMatchPen,
    qt_static_metacall,
    nullptr,
    nullptr
} };
