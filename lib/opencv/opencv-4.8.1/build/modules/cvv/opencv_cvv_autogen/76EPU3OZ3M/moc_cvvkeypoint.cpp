...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/cvvkeypoint.hpp"
...
void cvv::qtutil::CVVKeyPoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CVVKeyPoint *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (CVVKeyPoint::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::CVVKeyPoint::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__CVVKeyPoint.data,
    qt_meta_data_cvv__qtutil__CVVKeyPoint,
    qt_static_metacall,
    nullptr,
    nullptr
} };
