...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/matchmanagement.hpp"
...
void cvv::qtutil::MatchManagement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MatchManagement *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (MatchManagement::*)(const std::vector<cv::DMatch> & );
        ...
        {
            using _t = void (MatchManagement::*)(MatchSettings & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::MatchManagement::staticMetaObject = { {
    QMetaObject::SuperData::link<MatchSettings::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__MatchManagement.data,
    qt_meta_data_cvv__qtutil__MatchManagement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
