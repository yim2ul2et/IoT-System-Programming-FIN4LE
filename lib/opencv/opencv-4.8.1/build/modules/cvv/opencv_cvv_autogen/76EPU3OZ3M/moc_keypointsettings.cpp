...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/keypointsettings.hpp"
...
void cvv::qtutil::KeyPointSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KeyPointSettings *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (KeyPointSettings::*)(KeyPointSettings & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::KeyPointSettings::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__KeyPointSettings.data,
    qt_meta_data_cvv__qtutil__KeyPointSettings,
    qt_static_metacall,
    nullptr,
    nullptr
} };
