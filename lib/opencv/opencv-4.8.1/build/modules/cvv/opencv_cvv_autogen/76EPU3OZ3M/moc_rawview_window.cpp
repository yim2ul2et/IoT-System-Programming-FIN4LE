...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/matchview/rawview_window.hpp"
...
void cvv::qtutil::RawviewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RawviewWindow *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (RawviewWindow::*)(const std::vector<cv::DMatch> & );
        ...
        {
            using _t = void (RawviewWindow::*)(const std::vector<cv::KeyPoint> & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::RawviewWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__RawviewWindow.data,
    qt_meta_data_cvv__qtutil__RawviewWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
