...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/gui/rawview_table.hpp"
...
void cvv::gui::RawviewTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RawviewTable *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::gui::RawviewTable::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_cvv__gui__RawviewTable.data,
    qt_meta_data_cvv__gui__RawviewTable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
