...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/filter/changed_pixels_widget.hpp"
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::ChangedPixelsWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<FilterFunctionWidget<2,1>::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__ChangedPixelsWidget.data,
    qt_meta_data_cvv__qtutil__ChangedPixelsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
