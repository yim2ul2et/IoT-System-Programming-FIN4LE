...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/filter/diffFilterWidget.hpp"
...
void cvv::qtutil::DiffFilterFunction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DiffFilterFunction *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::DiffFilterFunction::staticMetaObject = { {
    QMetaObject::SuperData::link<FilterFunctionWidget<2,1>::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__DiffFilterFunction.data,
    qt_meta_data_cvv__qtutil__DiffFilterFunction,
    qt_static_metacall,
    nullptr,
    nullptr
} };
