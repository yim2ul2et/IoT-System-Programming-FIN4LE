...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/filter/channelreorderfilter.hpp"
...
void cvv::qtutil::ChannelReorderFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChannelReorderFilter *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::ChannelReorderFilter::staticMetaObject = { {
    QMetaObject::SuperData::link<FilterFunctionWidget<1,1>::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__ChannelReorderFilter.data,
    qt_meta_data_cvv__qtutil__ChannelReorderFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
