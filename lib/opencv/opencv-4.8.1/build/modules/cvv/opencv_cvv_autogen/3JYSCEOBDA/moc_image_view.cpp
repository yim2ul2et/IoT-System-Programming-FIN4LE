...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/view/image_view.hpp"
...
void cvv::view::ImageView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ImageView::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageView::updateLeftFooter)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageView::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageView::updateRightFoooter)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cvv::view::ImageView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_cvv__view__ImageView.data,
    qt_meta_data_cvv__view__ImageView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
