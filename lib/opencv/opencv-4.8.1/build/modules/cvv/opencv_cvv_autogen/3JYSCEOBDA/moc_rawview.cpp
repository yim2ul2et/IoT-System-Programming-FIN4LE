...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/view/rawview.hpp"
...
void cvv::view::Rawview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Rawview *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (Rawview::*)(const std::vector<cv::DMatch> & );
        ...
        {
            using _t = void (Rawview::*)(const std::vector<cv::KeyPoint> & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::view::Rawview::staticMetaObject = { {
    QMetaObject::SuperData::link<MatchView::staticMetaObject>(),
    qt_meta_stringdata_cvv__view__Rawview.data,
    qt_meta_data_cvv__view__Rawview,
    qt_static_metacall,
    nullptr,
    nullptr
} };
