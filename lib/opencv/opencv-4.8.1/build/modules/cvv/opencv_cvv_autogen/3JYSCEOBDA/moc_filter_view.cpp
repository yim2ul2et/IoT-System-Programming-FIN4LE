...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/view/filter_view.hpp"
...
void cvv::view::FilterView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FilterView *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (FilterView::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject cvv::view::FilterView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_cvv__view__FilterView.data,
    qt_meta_data_cvv__view__FilterView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
