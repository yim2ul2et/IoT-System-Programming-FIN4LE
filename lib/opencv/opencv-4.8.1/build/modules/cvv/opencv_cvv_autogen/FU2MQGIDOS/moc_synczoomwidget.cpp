...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/synczoomwidget.hpp"
...
void cvv::qtutil::SyncZoomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SyncZoomWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SyncZoomWidget::*)(QRectF , qreal ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SyncZoomWidget::updateArea)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::SyncZoomWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__SyncZoomWidget.data,
    qt_meta_data_cvv__qtutil__SyncZoomWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
