...
#include <memory>
#include "../../../../../../opencv_contrib-4.8.1/modules/cvv/src/qtutil/zoomableimage.hpp"
...
void cvv::qtutil::ZoomableImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ZoomableImage *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ZoomableImage::*)(const cv::Mat & , ImageConversionResult ) const;
        ...
        {
            using _t = void (ZoomableImage::*)(QRectF , qreal ) const;
        ...
        {
            using _t = void (ZoomableImage::*)(QPointF , QString , bool );
...
QT_INIT_METAOBJECT const QMetaObject cvv::qtutil::ZoomableImage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_cvv__qtutil__ZoomableImage.data,
    qt_meta_data_cvv__qtutil__ZoomableImage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
